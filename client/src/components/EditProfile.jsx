...
import { createProfile, getCurrentProfile, cleanProfile } from '../redux/actions/profileAction';

const EditProfile = ({ cleanProfile, createProfile, history, getCurrentProfile, profile: { profile, loading } }) => {
...
export default connect(mapStateToProps, { createProfile, getCurrentProfile, cleanProfile })(withRouter(EditProfile));
